...
bool ColorShaderClass::Initialize(ID3D11Device *device, HWND hWnd)
{
	...
	result = InitializeShader(device, hWnd, L"shaders\\color-v1.hlsl");
	if (!result)
	{
		return false;
	}
...
void ColorShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage, HWND hWnd, WCHAR *filename)
{
	char				*compileErrors;
