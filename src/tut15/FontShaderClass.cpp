...
bool FontShaderClass::Initialize(ID3D11Device *device, HWND hWnd)
{
	...
	result = InitializeShader(device, hWnd, L"shaders\\font-v1.hlsl");
	if (!result)
	{
		return false;
	}
...
void FontShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage, HWND hWnd, LPCWSTR filename)
{
	char				*compileErrors;
	SIZE_T				bufferSize, i;
	ofstream			fOut;
