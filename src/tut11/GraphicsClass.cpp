...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hWnd)
{
	...
	result = m_Model->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "models\\cube-v1.txt", "textures\\stone01.tga");
	if (!result)
	{
	...
	result = m_Bitmap->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), screenWidth, screenHeight, "textures\\seafloor.tga", 256, 256);
	if (!result)
	{
