...
bool TextureShaderClass::Initialize(ID3D11Device *device, HWND hWnd)
{
	...
	result = InitializeShader(device, hWnd, L"shaders\\texture-v1.hlsl");
	if (!result)
	{
		return false;
	}
...
bool TextureShaderClass::InitializeShader(ID3D11Device *device, HWND hWnd, WCHAR *filename)
{
	...
	result = D3DCompileFromFile(filename, NULL, NULL, "vs_main", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(filename, NULL, NULL, "ps_main", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage, HWND hWnd, WCHAR *filename)
{
	char				*compileErrors;
